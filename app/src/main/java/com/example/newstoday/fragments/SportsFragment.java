...
public class SportsFragment extends Fragment {
    ...
    private RecyclerView sports_RV;
    private NewsAdapter sports_adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sports_RV = view.findViewById(R.id.sports_RV);
        allSingleArticleArrayList = new ArrayList<>();

        progressBar = view.findViewById(R.id.sports_PB);
    ...
    private void prepareRecyclerView() {
        sports_RV.setHasFixedSize(true);
        sports_RV.setLayoutManager(new LinearLayoutManager(getContext()));
        sports_adapter = new NewsAdapter(getContext(), allSingleArticleArrayList);
        sports_RV.setAdapter(sports_adapter);
